 ...
 *
 * <pre>
 * curl localhost:8083/oauth/token -d "grant_type=password&scope=read&username=greg&password=turnquist" -u foo:bar
 * </pre>
 *
 * <ul>
 ...
 *
 * <pre>
 * curl -H "Authorization: bearer [access_token]" localhost:8083/flights/1
 * </pre>
 * <p>
 ...
 *      "_links" : {
 *          "self" : {
 *              "href" : "http://localhost:8083/flights/1"
 *          }
 *      }
 * }
 * </pre>
 ...
 *
 * <pre>
 * curl -i -H "Authorization: bearer [access token]" -H "Content-Type:application/json" localhost:8083/flights -X POST -d @flight.json
 * </pre>
 * <p>
 ...
 *
 * <pre>
 * Location: http://localhost:8083/flights/2
 *
 * curl -H "Authorization: bearer [access token]" localhost:8083/flights/2
 * </pre>
 *
 * @author Craig Walls
