...
public class OAuth2AuthorizationServerConfig {
  ...
  RegisteredClientRepository registeredClientRepository(JdbcTemplate jdbcTemplate) {
    ...
    RegisteredClient registeredClient = RegisteredClient.withId("client")
            ...
            .clientSecret("{bcrypt}$2a$04$kqRvgmJBlWZQQ2c9NT9IH.ZhxFY07Y2xE73vmLHxBq2hNTvGvUc5m")
  ...
  public JdbcUserDetailsManager jdbcUserDetailsManager(DataSource dataSource) {
    ...
    jdbcUserDetailsManager.createUser(User.withUsername("user")
            // Decrypted value - pass
            .password("{bcrypt}$2a$04$kqRvgmJBlWZQQ2c9NT9IH.ZhxFY07Y2xE73vmLHxBq2hNTvGvUc5m")
